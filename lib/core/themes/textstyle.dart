...
TextStyle txtHeading = GoogleFonts.poppins(
  textStyle: TextStyle(
    color: Colors.black,
...
TextStyle txtHeading20Black = GoogleFonts.poppins(
    textStyle: TextStyle(
      color: Colors.black,
      fontWeight: FontWeight.w600,
      fontSize: 20,
...
TextStyle txtRegularBlack = GoogleFonts.poppins(
    textStyle: TextStyle(
      color: Colors.black,
      fontWeight: FontWeight.w500,
      fontSize: 14,
...
TextStyle txtLink = GoogleFonts.poppins(
    textStyle: TextStyle(
...
TextStyle otpcode = GoogleFonts.poppins(
    textStyle: TextStyle(
        color: Colors.black,
...
TextStyle txtWhiteNormal = GoogleFonts.poppins(
    textStyle: TextStyle(
      color: Colors.white,
      fontWeight: FontWeight.normal,
      fontSize: 12,
