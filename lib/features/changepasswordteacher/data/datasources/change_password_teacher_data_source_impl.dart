...
import '../models/change_password_teacher_model.dart';
import 'change_password_teacher_data_source.dart';

class ChangePasswordTeacherDataSourceImpl implements ChangePasswordTeacherDataSource {
  final DioInstance dioInstance;

  ChangePasswordTeacherDataSourceImpl({required this.dioInstance});

  @override
  Future<bool> verifyOldPasswordTeacher(String oldPassword, String token) async {
    try {
  ...
  @override
  Future<void> changePasswordTeacher(ChangePasswordTeacherModel model, String token) async {
