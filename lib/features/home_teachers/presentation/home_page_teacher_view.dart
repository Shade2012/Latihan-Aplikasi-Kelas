  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: BlocConsumer<HomePageTeacherBloc,HomePageTeacherState>(
          bloc: context.read<HomePageTeacherBloc>()..add(AllScheduleEvent(selectedIndex: groupValue)),
                    ...
                    children: [
                            ...
                            return BlocBuilder<HomePageTeacherBloc,HomePageTeacherState>(
                              builder: (context, state) {
                                return DayContainerTeachers(value: index, groupValue: groupValue, onChanged: (int? value) {
                                  groupValue = value!;
                                  context.read<HomePageTeacherBloc>().add(AllScheduleEvent(selectedIndex: groupValue)
                                  );
                                }, day: day,);
                              },
                            );
                      ...
                      Expanded(
                        child: state is HomePageTeacherLoading
                            ...
                            ? ListView.separated(
                            itemBuilder: (context, index) {
                              final lecture = state.daySchedules[index].lectures;
