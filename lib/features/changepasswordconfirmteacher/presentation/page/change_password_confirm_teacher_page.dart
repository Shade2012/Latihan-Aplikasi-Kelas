...
import '../bloc/change_password_confirm_teacher_bloc.dart';
import '../bloc/change_password_confirm_teacher_event.dart';
import '../bloc/change_password_confirm_teacher_state.dart'; // For colors

class ChangePasswordConfirmTeacherPage extends StatelessWidget {
  const ChangePasswordConfirmTeacherPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            context.pushNamed('change_password_teacher_page');
          },
          icon: Container(
